...
}) => Promise<void>) | ((prefix?: string) => void) | ((meta: import("next/dist/server/request-meta").RequestMeta) => import("next/dist/server/base-server").BaseRequestHandler<import("next/dist/server/base-http/node").NodeNextRequest, import("next/dist/server/base-http/node").NodeNextResponse>) | undefined>;
