import { webpack } from '../../../../../ep-12/node_modules/next/dist/compiled/webpack/webpack';
import type { CustomRoutes } from '../../../../../ep-12/node_modules/next/dist/lib/load-custom-routes.js';
import type { CompilerNameValues } from '../../../../../ep-12/node_modules/next/dist/shared/lib/constants.js';
import type { NextConfigComplete } from '../../../../../ep-12/node_modules/next/dist/server/config-shared.js';
import type { Span } from '../../../../../ep-12/node_modules/next/dist/trace/index.js';
import type { MiddlewareMatcher } from '../../../../../ep-12/node_modules/next/dist/build/analysis/get-page-static-info.js';
import { type JsConfig, type ResolvedBaseUrl } from '../../../../../ep-12/node_modules/next/dist/build/load-jsconfig.js';
import type { NextBuildContext } from '../../../../../ep-12/node_modules/next/dist/build/build-context.js';
...
export default function getBaseWebpackConfig(dir: string, { buildId, encryptionKey, config, compilerType, dev, entrypoints, isDevFallback, pagesDir, reactProductionProfiling, rewrites, originalRewrites, originalRedirects, runWebpackSpan, appDir, middlewareMatchers, noMangling, jsConfig, jsConfigPath, resolvedBaseUrl, supportedBrowsers, clientRouterFilters, fetchCacheKeyPrefix, isCompileMode, previewProps, }: {
    ...
    supportedBrowsers: string[] | undefined;
    clientRouterFilters?: {
        staticFilter: ReturnType<import('../../../../../ep-12/node_modules/next/dist/shared/lib/bloom-filter.js').BloomFilter['export']>;
        dynamicFilter: ReturnType<import('../../../../../ep-12/node_modules/next/dist/shared/lib/bloom-filter.js').BloomFilter['export']>;
    };
